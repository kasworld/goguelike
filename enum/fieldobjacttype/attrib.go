...
var attrib = [FieldObjActType_Count]struct {
	...
	Blind:           {"?", true, true, 0.2, false, false, htmlcolors.DarkRed},
	Invisible:       {"?", true, true, 0.5, false, false, htmlcolors.LemonChiffon},
	Burden:          {"?", true, true, 0.2, false, false, htmlcolors.DeepPink},
	Float:           {"?", true, true, 0.3, false, false, htmlcolors.Wheat},
	Greasy:          {"?", true, true, 0.5, false, false, htmlcolors.PapayaWhip},
	Drunken:         {"?", true, true, 0.5, false, false, htmlcolors.Plum},
	Sleepy:          {"?", true, true, 0.1, false, false, htmlcolors.LightCoral},
