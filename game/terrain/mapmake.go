...
var cmdFnArgs = map[string]struct {
	...
	"AddPortalsRand":         {cmdAddPortalRand, "display:FieldObjDisplay_Type acttype:FieldObjAct_Type PortalID:string DstPortalID:string message:string"},
	"AddPortalsInRoom":       {cmdAddPortalRandInRoom, "display:FieldObjDisplay_Type acttype:FieldObjAct_Type PortalID:string DstPortalID:string message:string"},
