...
func MakeStartTower(name string) *towermake.Tower {
	...
	tw.GetByName("MazeWalk").ConnectPortalTo("Rand", "InRoom", tw.GetByName("Practice"))

	tw.GetByName("Practice").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("SoilPlant"))
	tw.GetByName("SoilPlant").ConnectStairUp("InRoom", "InRoom", tw.GetByName("ManyPortals"))
	tw.GetByName("ManyPortals").ConnectStairUp("InRoom", "InRoom", tw.GetByName("SoilWater"))
	tw.GetByName("SoilWater").ConnectStairUp("InRoom", "InRoom", tw.GetByName("SoilMagma"))
	tw.GetByName("SoilMagma").ConnectStairUp("InRoom", "InRoom", tw.GetByName("SoilIce"))
	tw.GetByName("SoilIce").ConnectStairUp("InRoom", "InRoom", tw.GetByName("MadeByImage"))
	tw.GetByName("MadeByImage").ConnectStairUp("InRoom", "InRoom", tw.GetByName("AgeingCity"))
	tw.GetByName("AgeingCity").ConnectStairUp("InRoom", "InRoom", tw.GetByName("AgeingField"))
	tw.GetByName("AgeingField").ConnectStairUp("InRoom", "InRoom", tw.GetByName("AgeingMaze"))
	tw.GetByName("AgeingMaze").ConnectStairUp("InRoom", "InRoom", tw.GetByName("RogueLike"))
	tw.GetByName("RogueLike").ConnectStairUp("InRoom", "InRoom", tw.GetByName("GogueLike"))
	tw.GetByName("GogueLike").ConnectStairUp("InRoom", "InRoom", tw.GetByName("Ghost"))
	tw.GetByName("Ghost").ConnectStairUp("InRoom", "Rand", tw.GetByName("FreeForAll"))
	tw.GetByName("FreeForAll").ConnectStairUp("Rand", "InRoom", tw.GetByName("SoilPlant"))

	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("SoilPlant"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("SoilWater"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("SoilMagma"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("SoilIce"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("MadeByImage"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("AgeingCity"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("AgeingField"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("AgeingMaze"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("RogueLike"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("GogueLike"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "InRoom", tw.GetByName("Ghost"))
	tw.GetByName("ManyPortals").ConnectPortalTo("InRoom", "Rand", tw.GetByName("FreeForAll"))
