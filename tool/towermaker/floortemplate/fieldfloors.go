...
func SoilPlant64x64() []string {
	return []string{
		...
		"AddRoomsRand bgtile=Room walltile=Wall terrace=false align=1 count=4 mean=6 stddev=4",
		"ConnectRooms tile=Road connect=1 allconnect=false diagonal=true",
	}
}
...
func SoilIce128x128() []string {
	return []string{
		...
		"AddRoomsRand bgtile=Room walltile=Wall terrace=false align=1 count=16 mean=6 stddev=4",
		"ConnectRooms tile=Road connect=1 allconnect=false diagonal=true",
	}
}
